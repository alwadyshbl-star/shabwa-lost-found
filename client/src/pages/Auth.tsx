...
export default function Auth() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      if (mode === "register") {
        await register.mutateAsync({ name, email, password, role: "user" });
