...
export default function EditReport() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      await update.mutateAsync({ id: reportId, reportType, itemKind, name, description, incidentDate, location, imageUrl: report.data?.imageUrl ?? "", contactName, contactPhone });
      toast.success("تم تحديث البلاغ.");
      navigate("/my-reports");
    } catch (error) { toast.error(error instanceof Error ? error.message : "تعذر تحديث البلاغ."); }
  };
